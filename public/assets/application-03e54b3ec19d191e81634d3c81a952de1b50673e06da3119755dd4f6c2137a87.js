 ...
 */
  ...
  var showBeautyAndSpas = function(lat, lng, link, name, previewImage, phone, productTitle, productPrice) {
      ...
      $.ajax({
            url: 'https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_201236_212556_0&filters=category:beauty-and-spas&offset=0&limit=20',
            dataType: 'jsonp',
  ...
  var showFoodDrink = function(lat, lng, link, name, previewImage, phone, productTitle, productPrice) {
      L.mapbox.featureLayer({
        type: 'Feature',
        geometry: {
          type: 'Point',
      ...
      $.ajax({
            url: 'https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_201236_212556_0&filters=category:food-and-drink&offset=0&limit=20',
            dataType: 'jsonp',
            success: function(biz2Data) {
            var data = biz2Data.deals;
             for (i = 0; i < data.length; i++) {
                ...
                showFoodDrink(bLat,bLng, link, name, previewImage, phone, productTitle, productPrice);
             };
            }
          });
  ...
  var showLocalServices = function(lat, lng, link, name, previewImage, phone, productTitle, productPrice) {
      L.mapbox.featureLayer({
        type: 'Feature',
        geometry: {
          type: 'Point',
      ...
      $.ajax({
            url: 'https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_201236_212556_0&filters=category:local-services&offset=0&limit=20',
            dataType: 'jsonp',
            success: function(biz2Data) {
            var data = biz2Data.deals;
             for (i = 0; i < data.length; i++) {
                ...
                showLocalServices(bLat,bLng, link, name, previewImage, phone, productTitle, productPrice);
             };
            }
          });
...
//   });
// });
  var showShopping = function(lat, lng, link, name, previewImage, phone, productTitle, productPrice) {
      L.mapbox.featureLayer({
        type: 'Feature',
        geometry: {
          type: 'Point',
      ...
      $.ajax({
            url: 'https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_201236_212556_0&filters=category:shopping&offset=0&limit=20',
            dataType: 'jsonp',
            success: function(biz2Data) {
            var data = biz2Data.deals;
             for (i = 0; i < data.length; i++) {
                ...
                showShopping(bLat,bLng, link, name, previewImage, phone, productTitle, productPrice);
             };
            }
          });
...
var showHealthFitness = function(lat, lng, link, name, previewImage, phone, productTitle, productPrice) {
  ...
  var showThingsToDo = function(lat, lng, link, name, previewImage, phone, productTitle, productPrice) {
      L.mapbox.featureLayer({
        type: 'Feature',
        geometry: {
          type: 'Point',
      ...
      $.ajax({
            url: 'https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_201236_212556_0&filters=category:things-to-do&offset=0&limit=20',
            dataType: 'jsonp',
            success: function(biz2Data) {
            var data = biz2Data.deals;
             for (i = 0; i < data.length; i++) {
                ...
                showThingsToDo(bLat,bLng, link, name, previewImage, phone, productTitle, productPrice);
             };
            }
          });
