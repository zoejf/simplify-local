 ...
 */
  ...
  var showLocalServices = function(lat, lng, link, name, previewImage, phone, productTitle, productPrice) {
      ...
      $.ajax({
            url: 'https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_201236_212556_0&filters=category:local-services&offset=0&limit=50',
            dataType: 'jsonp',
            success: function(biz2Data) {
            var data = biz2Data.deals;
             for (i = 0; i < data.length; i++) {
...
$(function() {
  ...
  var showShopping = function(lat, lng, link, name, previewImage, phone, productTitle, productPrice) {
      ...
      $.ajax({
            url: 'https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_201236_212556_0&filters=category:shopping&offset=0&limit=50',
            dataType: 'jsonp',
            success: function(biz2Data) {
            var data = biz2Data.deals;
             for (i = 0; i < data.length; i++) {
...
var showHealthFitness = function(lat, lng, link, name, previewImage, phone, productTitle, productPrice) {
    ...
    $.ajax({
          url: 'https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_201236_212556_0&filters=category:health-and-fitness&offset=0&limit=50',
          dataType: 'jsonp',
          success: function(biz2Data) {
          var data = biz2Data.deals;
           for (i = 0; i < data.length; i++) {
  ...
  var showThingsToDo = function(lat, lng, link, name, previewImage, phone, productTitle, productPrice) {
      ...
      $.ajax({
            url: 'https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_201236_212556_0&filters=category:things-to-do&offset=0&limit=50',
            dataType: 'jsonp',
            success: function(biz2Data) {
            var data = biz2Data.deals;
             for (i = 0; i < data.length; i++) {
